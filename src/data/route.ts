...
export const ROUTE_SEGMENTS: RouteSegment[] = [
  ...
  { startMile: 80, endMile: 90, terrain: 'downhill', location: 'Descent into town', crowdDensity: 'heavy', notes: 'Downhill. Gravity helps but your knees take the punishment.' },
  { startMile: 90, endMile: 100, terrain: 'flat', location: 'Larger town', crowdDensity: 'heavy', notes: 'Through a town. Spectacle. Noise. Confetti falls like snow.' },
  ...
  { startMile: 250, endMile: 270, terrain: 'rough', location: 'Deteriorating road', crowdDensity: 'sparse', notes: 'Cracked asphalt. Potholes. Every step demands attention.' },
  { startMile: 270, endMile: 300, terrain: 'flat', location: 'Through smaller towns', crowdDensity: 'sparse', notes: 'Late game. Surreal quiet. Empty storefronts. Faces in windows.' },
